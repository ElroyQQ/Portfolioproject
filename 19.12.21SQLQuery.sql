...
--For data on Covid cases and deaths 
SELECT *
...
--Shows likelihood of dying from Covid in Singapore
SELECT location, date, total_cases, total_deaths, (total_deaths/total_cases)*100 AS mortality_rate
FROM [Portfolio project]..Covid_deaths
WHERE total_deaths IS NOT NULL AND location = 'Singapore'

--Shows what percentage of population has got Covid in Singapore
